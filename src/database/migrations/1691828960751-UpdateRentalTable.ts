...
export class UpdateRentalTable1691828960751 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "rental" ALTER COLUMN "userId" DROP NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "rental" ALTER COLUMN "userId" SET NOT NULL`);
    }
